...
SECRET_KEY = 'django-insecure-7+n$_06sqf*=svvk549vyi9s3u)!ug!p97^lt%4r3arohtwxib'
...
CELERY_TIMEZONE = 'Asia/Tehran'  # یا timezone پروژه
...
CELERY_BEAT_SCHEDULE = {
    'send-campaigns-daily': {
        'task': 'dashboard.tasks.run_scheduled_campaigns',
        'schedule': 60.0,  # هر ۶۰ ثانیه
        #'schedule': crontab(hour=10, minute=0),  # هر روز ساعت 10 صبح
    },
}

# زمان پیش‌فرض سشن (ثانیه)
SESSION_COOKIE_AGE = 1209600  # دو هفته

# اگر True باشد، سشن با بستن مرورگر پاک می‌شود
