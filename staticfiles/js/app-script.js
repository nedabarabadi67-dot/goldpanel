$(function() {
    ...
    //sidebar menu js
    $.sidebarMenu($('.sidebar-menu-rtl')); // فقط کلاس RTL

    // === toggle-menu js
    $(".toggle-menu").on("click", function(e) {
        e.preventDefault();
        $("#wrapper").toggleClass("toggled-rtl"); // حتماً CSS RTL داشته باشید
    });	 
	   
    // === sidebar menu activation js
    $(function() {
        for (var i = window.location, o = $(".sidebar-menu-rtl a").filter(function() {
            return this.href == i;
    ...
    $(document).ready(function(){ 
        $(window).on("scroll", function(){ 
            ...
            $('.navbar-top').addClass('bg-dark navbar-dark').removeClass('bg-light navbar-light');
        } else { 
            $('.navbar-top').removeClass('bg-dark navbar-dark').addClass('bg-light navbar-light');
        }
        });
    });
